            ...
            if (ClientesView.acao == 1) {
                ...
                if (ClientesView.status == true) {
                    ...
                    if (ClientesView.statusFoto == JFileChooser.APPROVE_OPTION) {
                        ...
                        ClientesView.extensao = ClientesView.strNomeArquivoOrigem.substring(ultimoPonto + 1, ClientesView.strNomeArquivoOrigem.length());
                        ClientesView.strCaminhoDestino = "img\\system\\" + ClientesView.txtCampos[0].getText() + "." + ClientesView.extensao;
